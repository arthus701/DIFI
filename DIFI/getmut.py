...
def getmut(mjd2000, theta_NGP, phi_NGP, *args, **kwargs):
    ...
    #           theta_NGP       geographic co-latitude of North Geomagnetic Pole (deg)
    #           phi_NGP         geographic longitude of North Geomagnetic Pole (deg)
    ...
    eadj = (
        np.cos(theta_0_rad) * np.sin(theta_s_rad) * np.cos(phi_diff_rad)
